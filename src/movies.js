...
function getAllDirectors(moviesArray) {
    const onlyDirectors = moviesArray.map((obj) => {
        return obj.director
    }) 
...
function howManyMovies(moviesArray) {
    const spielbergDramaMovies = moviesArray.filter(({genre, director}) => genre.includes("Drama") && director === "Steven Spielberg");
...
function scoresAverage(moviesArray) {
    const average = moviesArray.reduce( (acum, currentValue) => acum + currentValue.score, 0 );
...
function dramaMoviesScore(moviesArray) {
    ...
    // const dramaMoviesAvg = dramaMovies.reduce((acum, currentElem) => acum + currentElem.score, 0);
    // return (dramaMoviesAvg / dramaMovies.length).toFixed(2)
}
...
function orderByYear(moviesArray) {
    const sortedfilms = moviesArray.sort((film1, film2) => {
...
console.log(orderByYear(movies))
    ...
    function orderAlphabetically(moviesArray) {
        const sortFilms = moviesArray.sort((movie1 , movie2) => {
